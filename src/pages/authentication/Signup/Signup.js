                ...
                <div className={cx('Rlj6l5')}>
                    <div className={cx('content')}>
                                    ...
                                    return (
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <div className={cx('button')}>
                                                <Button primary big type = "submit" disabled={!isValid || !interactionOccurred}>ĐĂNG KÝ</Button>                                                                   
                                            </div>                            
                                        </form>
                                    );
                                }}
                        ...
                        <div className={cx('fEA_sn')}>
                            <div className={cx('hrNwO1', 'PNGrtG')}>Bạn đã có tài khoản? 
                                <Link className={cx('U3bTnx')} to = "/buyer/login">Đăng nhập</Link>
                            </div>
                        </div>
                    </div>
                </div>
